...
(function($) {
    ...
    $.fn.pyramid = function( options ) {
        ...
        init = function() {
            ...
            if (screen.width>=300 && screen.width<579){
                var widthValue = 300, //divisible by 3, 4, 5 and 6
                    heightValue = 400;
            }
            if (screen.width>=580 && screen.width<768){
                var widthValue = 500, //divisible by 3, 4, 5 and 6
                    heightValue = 560;
            }
            if (screen.width>=768 && screen.width<1024){
                var widthValue = 580, //divisible by 3, 4, 5 and 6
                    heightValue = 600;
            }
            if(screen.width>=1024){
                var widthValue = 700, //divisible by 3, 4, 5 and 6
                    heightValue = 560;
            }
